...
; ************************************************************************************
;
;  Added 25/01/2026 Martin Sidgreaves
;  Added to enable 16C550 Dual UART Board on RC2014
;
; ************************************************************************************
UARTENABLE		.SET	TRUE		; UART: ENABLE 8250/16550-LIKE SERIAL DRIVER (UART.ASM)
...
AYMODE			.SET	AYMODE_RC2014	; AY: DRIVER MODE: AYMODE_[SCG|N8|RCZ80|RCZ180|MSX|LINC|MBC|DUO|NABU]
